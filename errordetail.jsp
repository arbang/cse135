...
<div class="sidebar-nav">
    <div class="well" style="width: 15%; height: 100%; position: fixed; padding: 8px 0;">
		<ul class="nav nav-list"> 
          ...
          <li class="active"><a href="errordetail.jsp"><i class="glyphicon glyphicon-warning-sign"></i> Your Errors <span class="badge badge-info">10</span></a></li>
		  <li><a href="members.jsp"><i class="glyphicon glyphicon-user"></i> Members</a></li>
