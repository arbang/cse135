...
<div class="sidebar-nav">
    <div class="well" style="width: 15%; height: 100%; position: fixed; padding: 8px 0;">
		<ul class="nav nav-list"> 
		  <li><a href="dashboard_perl.pl"><i class="glyphicon glyphicon-tasks"></i> Dashboard</a></li>
          <li><a href="#"><i class="glyphicon glyphicon-envelope"></i> Messages <span class="badge badge-info">4</span></a></li>
          <li class="active"><a href="errordetail.pl"><i class="glyphicon glyphicon-warning-sign"></i> Your Errors <span class="badge badge-info">10</span></a></li>
	...
	<img src="../images/errorpage.png" alt="hard image" style="margin-left:17%">
</div>
 <!-- /container -->
